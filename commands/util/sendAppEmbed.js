    ...
    async execute(interaction) {
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription(
                ...
                + '**Bot Developers**\n'
                + 'A bot developer\'s job is to help develop, maintain and update the bots in the server\n'
                + '**Requirements**\n'
                + '<a:4warrow:1229420261720461333> Must be at least 15 years of age\n'
                + '<a:4warrow:1229420261720461333> Must be familiar with Discord.JS\n'
                + '<a:4warrow:1229420261720461333> Must know basic javascript\n'
                + '<a:4warrow:1229420261720461333> Must have a public GitHub/portfolio with at least 3 small JS projects\n'
                + '<a:4warrow:1229420261720461333> Must have 2FA enabled\n'
                + '<a:4warrow:1229420261720461333> Must be in the server for more than 2 weeks\n'
                + '<a:4warrow:1229420261720461333> Must have at least 500 messages in chat or if you do not use the chat you must have at least 30 posts in the dm channels\n\n'
